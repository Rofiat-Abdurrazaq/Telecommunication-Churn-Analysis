...
11. Key Insights
Demographic & Contract Insights:
•	Married customers represent 64% of churned customers, indicating family decision-making impacts retention
•	Month-to-month contract holders are 3x more likely to churn than customers with annual contracts
•	New customers (0-3 months tenure) show the highest churn volume, revealing onboarding issues
Service & Product Insights:
•	Fiber Optic internet customers account for 66% of all churns (1,236 customers), indicating critical service quality issues
•	Customers without Online Security services are 40% more likely to churn
•	Electronic payment users (Bank Withdrawal, Credit Card) represent 92% of churned customers
Financial & Geographic Insights:
•	Top revenue cities (Los Angeles, San Diego) also generate the highest churn volume, representing maximum financial risk
•	The 17.24% revenue churn rate indicates loss of high-value customers
•	ARPU of $3,034.38 suggests significant revenue opportunity in retaining at-risk customers
